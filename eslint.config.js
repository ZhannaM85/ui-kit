...
module.exports = defineConfig([
    {
        ...
        // Indent: 4 spaces (SwitchCase: 1 for switch body)
        ...
        // Allow standalone: false (off everywhere)
    ...
    },
    {
        ...
        rules: {
        // Allow *ngIf / *ngFor (no requirement for @if / @for)
        "@angular-eslint/template/prefer-control-flow": "off",
        },
    },
    // Library components: prefix "kit"
    {
        files: ["src/**/*.ts"],
        rules: {
        "@angular-eslint/component-selector": [
